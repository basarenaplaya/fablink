        ...
        {CATEGORIES.map((category) => {
          ...
          return (
            <button
              ...
              className="group flex flex-col gap-4 rounded-xl border border-zinc-800 bg-zinc-950/70 p-6 text-left backdrop-blur-md transition-all hover:border-zinc-600 hover:bg-zinc-900/80 active:scale-[0.98]"
            >
